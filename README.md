...
- [Manage Words](#manage-words)
    - [Word List](#word-list)
    - [Adjusting Comfort Levels](#adjusting-comfort-levels)
    - [Managing external dictionaries to get single click results](#managing-external-dictionaries-to-get-single-click-results)
    - [Make use of backup files](#make-use-of-backup-files)
...
Feel free to customize this Ruby based applciation and run it on your own server or local machine.
